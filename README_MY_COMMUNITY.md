...
确保模型文件存在于：
```
/mnt/shared-storage-user/qianchen1/models/Qwen3-4B-Instruct-2507
```
...
```bash
cd /Users/junyao/Desktop/Dongrui_Liu/Multi_Agent/oasis
...
```
🚀 启动 Oasis Agent 社区...
📦 加载模型: /mnt/shared-storage-user/qianchen1/models/Qwen3-4B-Instruct-2507
✅ 模型加载成功
👥 创建 10 个 Agents...
  - Agent 0: Alice
  - Agent 1: Bob
